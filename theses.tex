\documentclass[oneside,phd]{ppgccufmg} % ou [msc] para dissertações
...
%\usepackage[pdftex,pdfa,pdfversion=1.4,english,bookmarks=true,bookmarksnumbered=true,linktocpage,colorlinks=true,citecolor=black,urlcolor=black,linkcolor=black,filecolor=black]{hyperref}
...
\ppgccufmg{
	...
	authorrev={Silva, Danilo Ferreira e},
	...
	approval={folha-aprovacao.pdf},
	abstract=[brazil]{Resumo}{resumo},
	abstract=[english]{Abstract}{abstract},
	cutter={S586m},
	cdu={519.6*32(043)},
	indexkeys={1.~Computação -- Teses. 2.~Refatoração de software. 3.~Engenharia de Software. 4.~Evolução de software. 5.~Mineração de repositórios de software. I.~Orientador. II.~Título.},
	%dedication={dedicatoria}
	ack=[Agradecimentos]{agradecimentos}
	%epigraphtext={Truth and lie are opposite things.}{Unknown},
}

\input{theses-ch1.tex}
\input{theses-ch2.tex}
\input{theses-ch3.tex}
\input{theses-ch4.tex}
\input{theses-ch5.tex}
\input{theses-ch6.tex}
